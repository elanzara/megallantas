       ...
       switch ($row['tip_id']){
        ...
        case 4:
            $pro_descripcion_seleccion = "Neumático ".$nueva_bus." ".$row['mar_descripcion']." "
                ...
                .$row['pro_med_diametro']." ".$row['pro_descripcion'];
            break;
        default:
            $pro_descripcion_seleccion = $row['pro_descripcion'];
            break;
       }
       $_SESSION["ocarrito"]->introduce_producto($row['pro_id'], $pro_descripcion_seleccion, $row['cantidad'],$row['precio'],0);//$pro_descuento );
...
<!--            <td class="rowGris">I.V.A.</td>-->
            ...
            <?php
            $mostrar = $_SESSION["ocarrito"]->imprime_carrito3($modif);
            echo $mostrar;
            ?>
       </table>
       <table align="center" cellpadding="0" cellspacing="1" class="form">
