 ...
 <div id="central">
  ...
  <table border="0" class="form">
   ...
   <td>
    ...
    $link=Conectarse();
    $ote = new orden_trabajo_enc();
    $orden_trabajo_enc = $ote->getorden_trabajo_encSQL2($baja, $search_sucursal, $todas);
    //Paginacion:
    //Limito la busqueda
    $TAMANO_PAGINA = 10;
    ...
    echo '<a href="alta_orden_trabajo.php?limpiar_form=S"><img src="images/add.png" alt="Agregar" align="absmiddle" /> Agregar orden de trabajo</a><br><br>';
...
//                            ."<option value='2'>En ejecución</option>"
   ...
   if ($row['estado']==1 or $row['estado']==4)/*Cancelada o Finalizada*/{
      print '<td class="formFields"><img src="images/edit.png" alt="Ver" align="absmiddle" /> <a href="modifica_orden_trabajo.php?md='.$row['ote_id'].'&modif=s"> Ver</a></td>';    
      print '<td class="formFields"></td>';
   } else { 
      print '<td class="formFields"><img src="images/edit.png" alt="Modificar" align="absmiddle" /> <a href="modifica_orden_trabajo.php?md='.$row['ote_id'].'"> Modificar</a></td>';
      print '<td class="formFields"><img src="images/print.jpg"  width="16" height="16" alt="Imprimir" align="absmiddle" /> <a href="imprimir_ot.php?ote_id='.$row['ote_id'].'" target="_blank"> Imprimir</a></td>';
    }
	  print '</tr>';
...
//    var sucursales = document.getElementById("sucursales").options[posicion].text); //valor
    ...
    if (document.getElementById("baja").checked == 1){
        location.href="abm_orden_trabajo.php?baja=S&todas="+todas+"&sucursales="+sucursales;
    } else {
        location.href="abm_orden_trabajo.php?baja=N&todas="+todas+"&sucursales="+sucursales;
    }
}
function VerTodas(){
    if (document.getElementById("baja").checked == 1){
...
//    var sucursales = document.getElementById("sucursales").options[posicion].text); //valor
    ...
    if (document.getElementById("todas").checked == 1){
        location.href="abm_orden_trabajo.php?todas=S&baja="+baja+"&sucursales="+sucursales;
    } else {
        location.href="abm_orden_trabajo.php?todas=N&baja="+baja+"&sucursales="+sucursales;
    }
}
</script>
