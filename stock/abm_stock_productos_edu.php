...
<div id="page"> 
 ...
 <div id="central">
  ...
  <!--AGREGAR SELECCION POR SUCURSALES-->
<?php
include_once 'class/sucursales.php'; // incluye las clases
$suc = new sucursales();
$resultado = $suc->getsucursales($suc_id);
//$cantidad = mysql_num_rows($resultado);
//$lineas = abs($cantidad / 4);
//$lineas = $lineas + 1;
echo "<table>";
echo "<tr>";
$cantidad = 0;
while($row= mysql_fetch_assoc($resultado)) {
	if ($cantidad < 3){
		echo "<td>";
		echo '<input type="checkbox" name="sucursal" value="1">Moron<br>';
		echo "</td>";
		$cantidad = $cantidad +1;
	} else {
		echo "<td>";
		echo '<input type="checkbox" name="sucursal" value="1">Caseros<br>';
		echo "</td>";
		echo "</tr>";
		echo "<tr>";
		$cantidad = 0;
...
?>
<!--<form action="">
	<input type="checkbox" name="sucursal" value="1">Caseros<br>
	<input type="checkbox" name="sucursal" value="2">Moron
</form>-->
<hr/>
  <!--FIN - AGREGAR SELECCION POR SUCURSALES-->
<!--    <table>
        <tr>
            <td>Sucursal:</td>
            <td>
