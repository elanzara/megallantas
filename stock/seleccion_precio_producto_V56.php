...
if ($_SERVER["REQUEST_METHOD"] == "GET"){
    ...
    $efectivo = number_format($pro->get_pro_precio_costo(),2);
    $tasa3 = $tp->get_tip_3cuotas();
    $tasa6 = $tp->get_tip_6cuotas();
    $tasa12 = $tp->get_tip_12cuotas();
    $cuotas3 = number_format(($efectivo*$tasa3/100)+$efectivo,2);
    $cuotas6 = number_format(($efectivo*$tasa6/100)+$efectivo,2);
    $cuotas12 = number_format(($efectivo*$tasa12/100)+$efectivo,2);
}
?>
