...
/*            $pdf =& new FPDI();
  ...
  */          
        ...
        if ($resultado>0 and $resultado2>0 and $_POST["tipo"] == "T"){
            ...
            $html2 .= "<table>";
            $html2 .= "<tr><td>";
            $texto = 'Se esta realizando una transferencia con fecha '.$_POST["fecha"].' bajo el número de remito '.$_POST["remito"].' desde la sucursal '.$ori.' a la sucursal '.$des.' con el siguiente detalle:';//\r\n';
            $html2 .= $texto;
                    ...
                    if (isset($tip_id)) {
                     if ($tip_id!="") {
                        ...
                        $res = $pro->getproductosCombo_MS($tip_id,$mar_id,$mod_id,$pro_med_ancho,$pro_med_diametro
                                ,$pro_distribucion,$tr_id,$pro_nueva,$pro_med_alto,'',$tipo,$_SESSION["suc_id"], $pro_id_seleccion);
                        print $res;
                     } else {
