...
<!--              <tr>
                ...
                <td>
                <textarea name="pro_descripcion" id="pro_descripcion" class="campos" cols="30" rows="2" onkeyup="this.value=this.value.toUpperCase()" ><?php print $pro_descripcion;?></textarea>
                </td>
              </tr>-->
            <?php
            }
                    ...
                    if (isset($tip_id)) {
                     if ($tip_id!="") {
                        ...
                        $res = $pro->getproductosCombo_MS($tip_id,$mar_id,$mod_id,$pro_med_ancho,$pro_med_diametro
                                ,$pro_distribucion,$tr_id,$pro_nueva,$pro_med_alto,$pro_descripcion,$tipo,$_SESSION["suc_id"]);
                        print $res;
                     } else {
...
<!--          </tr>
       ...
       <table align="center" cellpadding="0" cellspacing="1" class="form">
          <tr>
            ...
            <?php
            $mostrar = $_SESSION["ocarrito_stock"]->imprime_carrito2();
            echo $mostrar;
            ?>
          <tr>
            <td colspan="6" align="center" class="formFields">
