  ...
  <!--Start Tabla  -->
   <table class="form">
    ...
    print '<table class="form">'
          .'<tr class="rowGris">'
          .'<td  class="formTitle" width="100px" ><b>CLIENTE</b></td>'
	  ...
	  print '<td width="90px" class="formTitle" ></td>'
    ...
    while ($row=mysql_fetch_Array($_pagi_result))
    {
     print '<tr class="rowBlanco">'
	  ...
	  print '<td class="formField"><img src="images/delete.png" alt="Borrar" align="absmiddle" /><a href="abm_vehiculos.php?br='.$row['veh_id'].'">Borrar</a></td>'
	  .'<td class="formField"><img src="images/edit.png" alt="Modificar" align="absmiddle" /><a href="modifica_vehiculos.php?md='.$row['veh_id'].'">Modificar</a></td>'
          .'</tr>';
    }
    print '</table>';
    ?>
