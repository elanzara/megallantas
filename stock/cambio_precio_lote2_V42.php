...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($resultado == 1){
        $resp = "Se actualizaron del precios correctamente";
    } else {
...
$tabla = "<table>";
$tabla .= "<tr>";
//$tabla .= '<td width="0px" ></td>';//<b>pro_id</b>
...
$tabla .=  '<td class="formFields">'.$row['pro_precio_costo'] .'</td>';
$tabla .=  '<td class="formFields">'.$row['3cuotas'] .'</td>';
$tabla .=  '<td class="formFields">'.$row['6cuotas'] .'</td>';
$tabla .=  '<td class="formFields">'.$row['12cuotas'] .'</td>';
$tabla .= "</tr>";
}
$tabla .= "</table>";
/**
...
<form action="cambio_precio_lote2.php" method="post">
    <table>
        <tr></tr>
        <tr>
