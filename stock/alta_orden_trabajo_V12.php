...
function selectprecio(){
    ...
    window.open('seleccion_precio_producto.php?pro_id='+pro_id+'&tip_id='+tip_id+'&suc_id='+suc_id+'&observaciones='+observaciones+'&realizo='+realizo+'&cantidad='+cantidad+'&descuento='+descuento,'Selecciona precio por producto','scrollbars=No,status=yes,width=400,height=200,left=200,top=150 1');    
}
...
function agregar(){
  ...
  location.href = 'class/agregar_carrito.php?pro_id=' + pro_id + '&pro_descripcion=' + descripcion
      + '&pro_cantidad=' + cantidad + '&sucursal=' + sucursal + '&cli_id=' + cli_id + '&veh_id=' + veh_id
      + '&tip_id=' + tip_id + '&pro_id=' + pro_id + '&observaciones=' + observaciones + '&precio=' + precio +'&pro_descuento=' + pro_descuento + '&pmo_id=' + pmo_id+'&realizo='+realizo;
...
var suc_id=document.getElementById('sucursales').value; 
    ...
    if (posicion==2 || posicion==9){
        window.open('seleccion_producto.php?tip_id='+posicion+'&suc_id='+suc_id+'&observaciones='+observaciones+'&realizo='+realizo,'Selecciona producto','scrollbars=No,status=yes,width=1200,height=400,left=200,top=150 1');    
    } else if(posicion==4){
        window.open('seleccion_producto_neum.php?tip_id='+posicion+'&suc_id='+suc_id+'&observaciones='+observaciones+'&realizo='+realizo,'Selecciona producto','scrollbars=No,status=yes,width=1150,height=400,left=200,top=150 1');
    } else {
        window.open('seleccion_producto_gral.php?tip_id='+posicion+'&suc_id='+suc_id+'&observaciones='+observaciones+'&realizo='+realizo,'Selecciona producto','scrollbars=No,status=yes,width=1000,height=400,left=200,top=150 1');
    }
