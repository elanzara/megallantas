    ...
    function imprime_carrito2($fecha,$suc_id,$cli_id,$veh_id,$observaciones,$pmo_id,$realizo,$chk_veh){
       ...
       for ($i=0;$i<$this->num_productos;$i++){
        if($this->array_pro_id[$i]!=0){
            ...
            $mostrar = $mostrar . "<td class=rowBlanco style='width:90px;'>" . $this->array_pro_precio[$i] . "</td>";
            $mostrar = $mostrar . "<td class=rowBlanco style='width:90px;'>" . $this->array_pro_descuento[$i] . "</td>";
            $mostrar = $mostrar . "<td class=rowBlanco style='width:100px;'>" . $this->array_pro_importe[$i] . "</td>";
