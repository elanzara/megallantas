...
class carrito {
    ...
    function introduce_producto($pro_id,$pro_descripcion,$pro_cantidad,$pro_precio,$pro_descuento){
    ...
    function imprime_carrito2(){
       ...
       for ($i=0;$i<$this->num_productos;$i++){
        if($this->array_pro_id[$i]!=0){
            ...
            $mostrar = $mostrar . "<td class=rowBlanco>" . $this->array_pro_precio[$i] . "</td>";
            $mostrar = $mostrar . "<td class=rowBlanco>" . $this->array_pro_descuento[$i] . "</td>";
            $mostrar = $mostrar . "<td class=rowBlanco>" . $this->array_pro_importe[$i] . "</td>";
//            $mostrar = $mostrar . "<td class=rowBlanco>" . $this->array_pro_iva[$i] . "</td>";
            $mostrar = $mostrar . "<td class=rowBlanco><a href='class/eliminar_producto.php?linea=".
                    $i."'>Eliminar</td>";
            $mostrar = $mostrar . '</tr>';
...
//    			$suma += $precio * $cant; 
    ...
    function imprime_carrito3($modif){
       $mostrar = "";
       for ($i=0;$i<$this->num_productos;$i++){
        if($this->array_pro_id[$i]!=0){
            $mostrar = $mostrar . '<tr>';
...
//            $mostrar = $mostrar . "<td class=rowBlanco>" . $this->array_pro_iva[$i] . "</td>";
            if ($modif != 's') {
                $mostrar = $mostrar . "<td class=rowBlanco><a href='class/eliminar_producto_modif.php?linea=".
                            $i."'>Eliminar</td>";}
            $mostrar = $mostrar . '</tr>';
//    			$precio = $this->array_precio_prod[$i];
//    			$cant = $this->array_cantidad_prod[$i];
