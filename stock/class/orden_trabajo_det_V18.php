...
if ($ins_id>0){
    $sql1="INSERT INTO horden_trabajo_det
        (tipo, otd_id, pro_id, ote_id, cantidad, precio, observaciones, usu_id)
        VALUES
        ('I', $ins_id, '$this->pro_id', '$this->ote_id', '$this->cantidad', '$this->precio', '$this->observaciones'
            , '".$_SESSION["usu_id"]."')";
...
$sql="INSERT INTO horden_trabajo_det
     (tipo, otd_id, pro_id, ote_id, cantidad, precio, observaciones, usu_id)
     SELECT
        'U', otd_id, pro_id, ote_id, cantidad, precio, observaciones, '".$_SESSION["usu_id"]."'
...
$sql="INSERT INTO horden_trabajo_det
     (tipo, otd_id, pro_id, ote_id, cantidad, precio, observaciones, usu_id)
     SELECT
        'B', otd_id, pro_id, ote_id, cantidad, precio, observaciones, '".$_SESSION["usu_id"]."'
     FROM orden_trabajo_det
     WHERE otd_id= '$this->otd_id'";
$result=mysql_query($sql,$link);
if ($result>0){
