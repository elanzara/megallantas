...
function baja_mov(){
$link=Conectarse();
$sql="update movimientos_stock set mov_estado = '1' where mov_id = '$this->mov_id'";
$result=mysql_query($sql,$link);
if ($result>0){
return 1;
} else {
...
function getmovimientos_stockSQL($search_sucursal = "",$search_tipo_producto = "",$search_producto = "", $fecha="", $hasta="")
{
$link=Conectarse();
$fechaNormal = new fechas();
if (($search_sucursal=="" or $search_categoria=="0") and ($search_tipo_producto=="" or $search_tipo_producto=="0")
     and ($search_nombre == "") and ($fecha =="") and ($hasta =="")){
    //Ingreso/Egreso:
