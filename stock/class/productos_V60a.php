...
function getCantidadProductoConFecha($pro_id=0,$suc_id=0,$fecha='') {
    ...
    if ($pro_controla_stock == "S"){
        ...
        $cantidad=0;
    }//echo("stoc:".$cantidad_stock);echo("inicial:".$cant_inicial);echo("cant:".$cantidad);
    return $cantidad;
}
...
//echo("f:".$fecha);
    ...
    while (strtotime($startTime) <= strtotime($endTime)) {
        ...
        $cant_prod=$this->getCantidadProductoConFecha($pro_id,$suc_id,$fechaNormal->cambiaf_a_normal($startTime));
