 ...
 <div id="central">
  ...
  <!--Start Tabla  -->
   <table class="form">
    ...
    $stock = $mov->getmovimientos_stockSQL($search_sucursal,$search_tipo_producto,$search_producto
            ,$_SESSION["search_fecha"],$_SESSION["search_hasta"],$_SESSION["search_cod_mvto"]);
    //Paginacion: 
    //Limito la busqueda
    $TAMANO_PAGINA = 10;
    $_pagi_sql = $stock;
