 ...
 <table class="form">
  ...
  <td>
    ...
    print '<table class="form">'
	 .'<tr class="rowGris">'
     .'<td  class="formTitle" width="150px"><b>Descripción</b></td>'
	 .'<td  class="formTitle" width="150px"><b>Mail</b></td>'
    ...
    while ($row=mysql_fetch_Array($_pagi_result)) 
    {
     print '<tr class="rowBlanco">'
	  ...
	  .'<td class="formFields" width="90px"> <img src="images/delete.png" alt="Borrar" align="absmiddle" /><a href="abm_usuarios.php?br='.$row['usu_id'].'">  Borrar</a></td>'	// lo correcto seria enviarlos por post con un submit por ejem.
          .'<td class="formFields" width="90px"><img src="images/edit.png" alt="Modificar" align="absmiddle" /> <a href="modifica_usuarios.php?md='.$row['usu_id'].'"> Modificar</a></td>'
	  .'</tr>';       
    }
    print '</table>';
     ?>
