...
if (isset($_GET['md'])) {
    ...
    while($row= mysql_fetch_assoc($consulta)) {
       ...
       $_SESSION["ocarrito"]->introduce_producto($row['pro_id'], $pro_descripcion_seleccion, $row['cantidad'],$row['precio'],0,$row['observaciones']);//$pro_descuento );
     ...
     <form name="formulario" id="formulario" action="modifica_orden_trabajo.php" method="POST" enctype="multipart/form-data">
       ...
       <table align="center" cellpadding="0" cellspacing="1" class="form">
          ...
          <tr>
            ...
            <td class="formFields">
                <input type="text" id="cantidad" name="cantidad" size="10" value="<?php print $cantidad; ?>" onkeyUp="validarNro(this)" />
            </td>
            <td class="formTitle">PRECIO</td>
            <td class="formFields">
                <input type="text" id="precio" name="precio" size="10" ondblclick="selectprecio();" 
                       value="<?php print $precio; ?>" onkeyUp="validarNro(this)" />
            </td>
            <td class="formTitle">DESCUENTO(%)</td>
            <td class="formFields">
                <input type="text" id="descuento" name="descuento" size="8" value="<?php print $descuento; ?>" onkeyUp="validarNro(this)" />
            </td>
            <td class="formTitle">OBSERVACIONES</td>
            <td class="formFields">
