    ...
    <div id="menu" class="menu">
      <ul id="navg">
        ...
        <li><a href="abm_primera_pag.php">REPORTES</a>
          <ul>
            <?php
            if(Opciones_habilitadas($_SESSION["rol_id"],'RESUMEN DIARIO')=='S') {
            ?>
                <li><a href="rep_resumen_diario.php">RESUMEN DIARIO</a></li>
            <?php
            }
            if(Opciones_habilitadas($_SESSION["rol_id"],'NEUMATICOS VENDIDOS')=='S') {
            ?>
                <li><a href="rep_neumaticos_vendidos.php">NEUMATICOS VENDIDOS</a></li>
            <?php
            }
            if(Opciones_habilitadas($_SESSION["rol_id"],'NEUMATICOS INGRESADOS')=='S') {
            ?>
                <li><a href="rep_neumaticos_ingresados.php">NEUMATICOS INGRESADOS</a></li>
            <?php
            }
            ?>
          </ul>
