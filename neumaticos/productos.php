...
message = "Reparación de Llantas - Megallantas";
...
<div align="center">
  ...
  <table border="0" width="600" id="table6" cellspacing="0" cellpadding="4" style="border-width: 0px" background= "novedades/ofertas/images/neumaticos/1_bg2.gif)%20no-repeat%20top">
	<tr>
...
<!--FIN MENU IZQUIERDA -->
				...
				<p align="left" style="margin-top: 0; margin-bottom: 0">&nbsp;<span class="popup-texto2">
							    ...
							    <span class="popup-texto2">&nbsp; +54 11</span> <span class="popup-texto2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;4555-0344 <br>
&nbsp; 4553-3977<br>
&nbsp;&nbsp;Id 597*1138</span>
				    <p align="left" style="margin-top: 0; margin-bottom: 0"><span class="popup-texto2">				  <br>
				  <font color="#FFCF00" face="Arial" size="2">&nbsp;Horarios</font><br>
&nbsp;&nbsp;Lunes a Viernes<br>
&nbsp;&nbsp;08:00 a 19:00 Hs<br>
&nbsp;&nbsp;Sabados<br>
&nbsp;&nbsp;08:00 a 14:00 Hs<br>
					...
					<tr>
						<td style="border-style: none; border-width: medium">
            				<table border="0" width="465" id="table76" cellspacing="0" cellpadding="0" height="40" background="../images/neumaticos/titulos.jpg">
            					<tr>
            						<td width="465">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            						<i class="ofertat">MARCAS QUE TRABAJAMOS </i></td>
            					</tr>
            				</table>
...
<table width="100%" border="1" cellpadding="4" cellspacing="0" id="table71" style="border-width: 1px">
					<tr>
						...
						<font color="#FFFFFF" face="Arial" size="2">Si no encontras aca lo que necesitas, llamanos y te lo conseguimos.</font>

<!-- GRUPO-->
                    <tr>
                    <td valign="top" width="766" height="528" class="footer" ><i class="ofertat">Neumaticos</i><br><br><img border="0" src="../admin/imagenes_categoria/neumaticos.jpg" width="444" height="518"></td>
					</tr>
					 <tr>
                    <td valign="top" width="766" height="327" class="footer" ><i class="ofertat">Llantas Deportivas y Replicas</i><br><br><img border="0" src="../admin/imagenes_categoria/replicas.jpg" width="462" height="298"></td>
					</tr>	
					<tr>
                    <td valign="top" width="766" height="599" class="footer" ><i class="ofertat">Llantas Originales</i><br><br><img border="0" src="../admin/imagenes_categoria/originales.jpg" width="462" height="564"></td>
					</tr>					
				</table>
